...
Wherever JavaScript expects a statement, you can also write an expression. Such a statement is called an \textit{expression statement}.
...
\item returned array whether retain the element or the return value (filter() retain the element, not the return value)
