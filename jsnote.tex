...
\subsubsection{组件注册}
当直接在 DOM 中使用一个组件 (而不是在字符串模板 template 或单文件组件) 的时候，我们强烈推荐遵循 W3C 规范中的自定义组件名 (字母全小写且必须包含一个连字符)，可以参考\href{https://cn.vuejs.org/v2/style-guide}{基础组件名}的“详解”的“这样做的几个好处”部分
